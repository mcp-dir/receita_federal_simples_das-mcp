...
Receita Federal: Simples (Emissão de DAS de MEI) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [receita_federal_simples_das@mcp.ai](mailto:receita_federal_simples_das@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
